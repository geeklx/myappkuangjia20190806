...
import com.example.slbappcomm.utils.cutimg.DownloadShareImgUtil;
import com.example.slbappcomm.utils.cutimg.ShareBitmapUtils;
import com.example.slbappcomm.utils.cutimg.ShareImgCutUtil;
...
//        JShareInterface.share(name, WeixinBeanParam.share_img1(CommonUtils.img_file_url + CommonUtils.img_file_name2), jPushShareUtils.mShareListener1);
        ...
        downloadShareImgUtil.downloadPicture(false, activity, bitmap, CommonUtils.img_file_url, aaaa);
        JShareInterface.share(name, WeixinBeanParam.share_img1(CommonUtils.img_file_url + aaaa), jPushShareUtils.mShareListener1);
    }
...
//            downloadShareImgUtil.downloadPicture(true, activity, bitmap, CommonUtils.img_file_url, CommonUtils.img_file_name2);// 保存最近
            downloadShareImgUtil.downloadPicture(true, activity, bitmap, CommonUtils.img_file_url, SystemClock.currentThreadTimeMillis() + ".jpg");// 保存多张
            dismiss();
