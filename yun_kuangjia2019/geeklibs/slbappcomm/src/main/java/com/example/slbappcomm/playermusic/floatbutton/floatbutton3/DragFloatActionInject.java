...
//                Intent intent = new Intent("hs.act.slbapp.ListenMusicActivity");
                ...
                intent.putExtra(CommonUtils.HUIBEN_IDS_ZONG, getFloat_id_zong());
                intent.putExtra(CommonUtils.HUIBEN_IDS, getFloat_id());
                intent.putExtra(CommonUtils.HUIBEN_TITLES, getFloat_name());
                intent.putStringArrayListExtra(CommonUtils.HUIBEN_XMLY, getFloat_xmly());
