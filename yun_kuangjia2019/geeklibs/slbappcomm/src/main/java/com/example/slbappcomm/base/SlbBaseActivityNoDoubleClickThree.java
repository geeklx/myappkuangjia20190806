...
public abstract class SlbBaseActivityNoDoubleClickThree extends AppCompatActivity implements IBaseAction {
...
//                Toast.makeText(SlbBaseActivity.this, "单击时我执行", Toast.LENGTH_SHORT).show();
                v.setEnabled(false);
                handler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        if (SlbBaseActivityNoDoubleClickThree.this.isFinishing() || SlbBaseActivityNoDoubleClickThree.this.isDestroyed()) {
                            return;
                        }
                        v.setEnabled(true);
                    }
...
//                Toast.makeText(SlbBaseActivity.this, "长按时我执行", Toast.LENGTH_SHORT).show();
            }
...
//                Toast.makeText(SlbBaseActivity.this, "焦点变化时我执行", Toast.LENGTH_SHORT).show();
            }
        });
...
//        MobEvent.onPause(this);
        AppUtils.registerAppStatusChangedListener(this, new Utils.OnAppStatusChangedListener() {
            ...
            public void onForeground() {
                ...
                if (SPUtils.getInstance().getBoolean("huyan", false)) {
                    startService(new Intent(SlbBaseActivityNoDoubleClickThree.this, Huyanservices.class));
                }
            }
            ...
            public void onBackground() {
                // 后台
                if (SPUtils.getInstance().getBoolean("huyan", false)) {
                    stopService(new Intent(SlbBaseActivityNoDoubleClickThree.this, Huyanservices.class));
                }
            }
        });
    }
     ...
     * @param activity
     */
    public void targetToIfLogin(final Class<? extends SlbBaseActivityNoDoubleClickThree> activity) {
