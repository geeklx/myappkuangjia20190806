...
//
//public class ReadBookActivityBeiben extends SlbBaseActivity implements ImgCallBack {
//
...
//                    R.drawable.i1, mGoodsList.get(i).getUrl(),mGoodsList.get(i).getUrl_mp3());
//            mList.add(baseBean2);
//        }
//        return mList;
//    }
...
//            mGoodsList.add(new HuibenFileCacheBean(items.get(i).getId() + "", items.get(i).getUrl(),items.get(i).getUrl_mp3()));
//        }
...
//        adapter = new BasemusicAdapter2(this, items,this);
