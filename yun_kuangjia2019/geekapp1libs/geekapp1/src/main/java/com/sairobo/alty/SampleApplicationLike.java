...
public class SampleApplicationLike extends DefaultApplicationLike {
    ...
    public void onCreate() {
        ...
        configBugly();
        // 语言切换
        LocalManageUtil.setApplicationLanguage(getApplication());
//        GlideOptionsFactory.init(this, R.drawable.ic_def_loading);
        ...
        configRetrofitNet();
        Utils.init(getApplication());// com.blankj:utilcode:1.17.3
        AutoEx.apply();
        //初始化极光分享
        configShare();
        //初始化极光统计
...
//        cofigPhone();
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        //保存系统选择语言
        LocalManageUtil.onConfigurationChanged(getApplication());
    }
    ...
    private void configUmengTongji() {
        ...
        if (TextUtils.equals(BanbenCommonUtils.banben_comm, "测试")) {
            ...
            UMConfigure.init(getApplication(), "5cfdbb010cafb2af14000480", channel, UMConfigure.DEVICE_TYPE_PHONE, null);
        } else if (TextUtils.equals(BanbenCommonUtils.banben_comm, "预生产")) {
            UMConfigure.setLogEnabled(true);
            UMConfigure.init(getApplication(), "5cfdbb524ca357e9d900047b", channel, UMConfigure.DEVICE_TYPE_PHONE, null);
    ...
    private void cofigPhone() {
        Intent intent = new Intent(getApplication(), PhoneService.class);
...
//            CrashReport.initCrashReport(getApplicationContext(), "92e2540923", true);// 测试
            Bugly.init(getApplication(), "92e2540923", true);
            MyLogUtil.on(true);
            //
...
//            CrashReport.initCrashReport(getApplicationContext(), "99f9f601e0", true);// 预生产
            Bugly.init(getApplication(), "99f9f601e0", true);
            MyLogUtil.on(true);
        } else if (TextUtils.equals(BanbenCommonUtils.banben_comm, "线上")) {
//            CrashReport.initCrashReport(getApplicationContext(), "99f9f601e0", false);// 线上
            Bugly.init(getApplication(), "99f9f601e0", false);
            MyLogUtil.on(false);
        }
    }
    ...
    private void configShare() {
        ...
        JShareInterface.init(getApplication(), platformConfig);
    }
