...
public class Fragment2Factory {
    ...
    public void set_brc_fragment21and22_change(Context context) {
        ...
        LocalBroadcastManagers.getInstance(context.getApplicationContext()).sendBroadcast(msgIntent21);
        LocalBroadcastManagers.getInstance(context.getApplicationContext()).sendBroadcast(msgIntent22);
    }
    ...
    static {
        ...
        sIndexFragments.put(R.id.fragment2_pager_index_0_1, FragmentContent21Img.class);//模块1
//        sIndexFragments.put(R.id.fragment2_pager_index_1_0, FragmentContent22Demo.class);//模块2
        ...
        sIndexFragments.put(R.id.fragment2_pager_index_1_1, FragmentContent22Video.class);//模块2
...
//                                            Jzvd.startFullscreen(context, JzvdStd.class, CopyAssetsToLujingUtils.getInstance(context).images_video[1], "网络视频播放");
                                            JZVideoPlayerStandard.startFullscreen(context, JZVideoPlayerStandard.class, CopyAssetsToLujingUtils.getInstance(context).images_video[1], "网络视频播放");
