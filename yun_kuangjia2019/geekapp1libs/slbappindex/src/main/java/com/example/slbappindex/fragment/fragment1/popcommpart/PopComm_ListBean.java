 ...
 */
public class PopComm_ListBean implements Serializable {
    /**
     *
     */
    ...
    public PopComm_ListBean() {
    }

    public PopComm_ListBean(String text_id, String text_content, int text_icon, int text_icon2, boolean enselect) {
