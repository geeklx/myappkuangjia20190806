...
public class FragmentContent4 extends SlbBaseFragment implements View.OnClickListener, SGetUserInfoView, SUploadUserImgView {

    private String tablayoutId;
    private Context mContext;
    private TextView tv1;// 访客登录
    private TextView tv2;// 3岁
    private TextView tv_vip2;// 3岁
    private TextView tv_vipcode1;// 3岁
    private TextView tv3;// 23
    private TextView tv4;// 0.5
    private TextView tv_jinbi2;// 0.5
    ...
    private RelativeLayout rldd2;
    private Button btnSure;
    private Button btnCancel;
    // 上传头像bufen
    private boolean is_scg_img = true;
...
//        Bundle arg = getArguments();
    ...
    protected void setup(View rootView, @Nullable Bundle savedInstanceState) {
        ...
        tv_vip2 = rootView.findViewById(R.id.tv_vip2);
        tv_vipcode1 = rootView.findViewById(R.id.tv_vipcode11);
        tv_vip2.setOnClickListener(this);
        tv_vipcode1.setOnClickListener(this);
        tv3 = rootView.findViewById(R.id.tv3);
        tv4 = rootView.findViewById(R.id.tv4);
        tv_jinbi2 = rootView.findViewById(R.id.tv_jinbi2);
        ...
        rl0 = rootView.findViewById(R.id.rl0);
        ...
        rldd2 = rootView.findViewById(R.id.rldd2);
        rldd2.setOnClickListener(this);
...
//            });
            // 免费绘本
            // 下载页面
//            startActivity(new Intent("hs.act.slbapp.DownActivity"));
            // 分享页面
...
//                            jPushShareUtils.drawableToBitmap(getActivity(), getActivity().getDrawable(R.drawable.geek_icon))),
//                    jPushShareUtils.mShareListener1);
            // 订单支付
//            startActivity(new Intent("hs.act.slbapp.OrderPayActivity"));
...
//            HiosHelper.resolveAd(getActivity(), getActivity(), "http://47.110.35.186/user-notice/123.html");
...
//        SPUtils.getInstance().put(CommonUtils.USER_TOKEN, sLoginUserInfoBean.getToken());
        ...
        if (TextUtils.isEmpty(sLoginUserInfoBean.getPbUser().getChildAge())) {
            ...
            tv2.setText(sLoginUserInfoBean.getPbUser().getChildAge() + "岁");
        }
        if (TextUtils.isEmpty(sLoginUserInfoBean.getPbUser().getVipEndDate())) {
            tv_vip2.setVisibility(View.GONE);
            tv_vip2.setText("");
        } else {
            tv_vip2.setVisibility(View.VISIBLE);
            tv_vip2.setVisibility(View.VISIBLE);
            tv_vip2.setText(sLoginUserInfoBean.getPbUser().getVipEndDate());
        }
//        if (TextUtils.isEmpty(sLoginUserInfoBean.getPbUser().getChildAge())) {
