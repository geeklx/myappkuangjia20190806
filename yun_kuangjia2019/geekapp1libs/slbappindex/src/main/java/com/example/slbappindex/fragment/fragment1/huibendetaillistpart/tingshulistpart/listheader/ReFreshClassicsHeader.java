package com.example.slbappindex.fragment.fragment1.huibendetaillistpart.tingshulistpart.listheader;
...
public class ReFreshClassicsHeader extends LinearLayout implements RefreshHeader {
    ...
    public ReFreshClassicsHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context);
    }

    public ReFreshClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        ...
        mHeaderText.setTextColor(ContextCompat.getColor(context, R.color.color_4DA3FE));
        mProgressDrawable = new ProgressDrawable();
        mProgressDrawable.setColor(ContextCompat.getColor(context, R.color.color_4DA3FE));
