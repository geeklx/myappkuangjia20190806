...
public class MoreHuibenImgStyle1ProviderNew1 extends BaseItemProvider<MoreHuibenImgBeanReadBook, BaseViewHolder> {

    @Override
    public int viewType() {
        return MoreHuibenImgAdapterNew1.STYLE_ONE;
    }
