...
public class CategoryDiffStyle3ProviderNew2Index extends BaseItemProvider<CategoryDiffBeanNew2Index, BaseViewHolder> {

    @Override
    public int viewType() {
        return CategoryDiffAdapterNew2Index.STYLE_THREE;
    }
