...
public class MoreHuibenImgStyle3ProviderNew1 extends BaseItemProvider<MoreHuibenImgBeanReadBook, BaseViewHolder> {

    @Override
    public int viewType() {
        return MoreHuibenImgAdapterNew1.STYLE_THREE;
    }
