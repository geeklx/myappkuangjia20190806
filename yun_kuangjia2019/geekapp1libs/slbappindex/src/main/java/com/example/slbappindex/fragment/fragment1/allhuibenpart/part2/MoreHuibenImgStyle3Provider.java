...
public class MoreHuibenImgStyle3Provider extends BaseItemProvider<MoreHuibenImgBean, BaseViewHolder> {

    @Override
    public int viewType() {
        return MoreHuibenImgAdapter.STYLE_THREE;
    }

    @Override
    public int layout() {
        return R.layout.activity_fragment21_imgstyle4_item;
    }
