...
public class MoreHuibenImgBeanReadBook implements Serializable {
    ...
    public MoreHuibenImgBeanReadBook(int type) {
        this.type = type;
    }

    public MoreHuibenImgBeanReadBook(int type, SCommonCategoryRecommendBean2 mBean) {
        this.type = type;
        this.mBean = mBean;
    }
