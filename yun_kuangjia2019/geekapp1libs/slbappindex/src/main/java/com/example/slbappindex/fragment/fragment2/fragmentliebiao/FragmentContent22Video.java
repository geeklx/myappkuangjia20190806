...
public class FragmentContent22Video extends SlbBaseFragment {
    ...
    public void onDestroyView() {
        super.onDestroyView();
        LocalBroadcastManagers.getInstance(getActivity().getApplicationContext()).unregisterReceiver(mMessageReceiver);
    }
...
//            mAdapter.setEmptyView(getView());
    ...
    private void jump_img_loc_yulan(Fragment22VideoBean addressBean) {
        // 打开assets下复制到本地视频
        JZVideoPlayerStandard.startFullscreen(getActivity(), JZVideoPlayerStandard.class, addressBean.getmBean().getUserAvatar(), "本地视频");
