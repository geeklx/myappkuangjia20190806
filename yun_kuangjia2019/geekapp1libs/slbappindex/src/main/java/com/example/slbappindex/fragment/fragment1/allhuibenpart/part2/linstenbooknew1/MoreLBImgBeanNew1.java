...
public class MoreLBImgBeanNew1 implements Serializable {
    ...
    public MoreLBImgBeanNew1(int type) {
        this.type = type;
    }

    public MoreLBImgBeanNew1(int type, SCommonCategoryRecommendBean2 mBean) {
        this.type = type;
        this.mBean = mBean;
    }
