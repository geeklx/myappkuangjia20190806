...
//                list.add(new MoreHuibenImgBean(MoreHuibenImgBean.style2, new MoreHuibenChildImgBean(false,"","","",bean2)));
                list.add(new Fragment21ImgBean(Fragment21ImgBean.style3, status));
...
//                        DateUtil.FORMATER_YMD);
                ...
                status.setUserAvatar(img_file.toString());
                status.setText("这是一款神奇的工具");
//                list.add(new MoreHuibenImgBean(MoreHuibenImgBean.style2, new Fragment22ChildVideoBean(false,"","","",bean2)));
