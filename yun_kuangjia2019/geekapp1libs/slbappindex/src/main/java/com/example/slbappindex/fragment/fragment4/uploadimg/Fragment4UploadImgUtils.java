package com.example.slbappindex.fragment.fragment4.uploadimg;
...
public class Fragment4UploadImgUtils {
    ...
    private static Fragment4UploadImgUtils instance;
    private Context mContext;

    private Fragment4UploadImgUtils(Context context) {
        mContext = context;
    }

    public static Fragment4UploadImgUtils getInstance(Context context) {
        if (instance == null) {
            synchronized (Fragment4UploadImgUtils.class) {
                instance = new Fragment4UploadImgUtils(context.getApplicationContext());
            }
        }
        return instance;
    }
...
//        });
     ...
     */
    public void gotoClipActivity(Context context, Uri uri) {
        if (uri == null) {
            return;
        }
