...
public class SIndexCategoryListAllPresenter extends Presenter<SIndexCategoryListAllView> {
...
//        requestData.put("params", JSON.toJSON(params));
        ...
        RetrofitNetNew.build(SIndexApi.class, getIdentifier()).get_index_categoryListAllnew1(BanbenUtils.getInstance().getVersion(),
                BanbenUtils.getInstance().getImei(), BanbenUtils.getInstance().getToken(), requestBody).
                enqueue(new Callback<ResponseSlbBean<SCategoryBean>>() {
            @Override
